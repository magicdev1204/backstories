...
<?php endif; ?>
    ...
    <link href="<?= base_url('assets/css/style-4.2.min.css'); ?>" rel="stylesheet"/>
<?php if ($darkMode == 1) : ?>
    <link href="<?= base_url('assets/css/dark-4.2.min.css'); ?>" rel="stylesheet"/>
<?php endif;
if ($activeLang->text_direction == "rtl"): ?>
    <script>var rtl = true;</script>
    <link href="<?= base_url('assets/css/rtl-4.2.min.css'); ?>" rel="stylesheet"/>
<?php else: ?>
