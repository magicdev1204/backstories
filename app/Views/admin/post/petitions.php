        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <?php if (hasPermission('add_post')): ?>
                    <div class="right">
                        <div class="dropdown">
                            <button class="btn btn-success btn-add-new dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-plus"></i><?= trans('add_petition'); ?>
                                                ...
                                                <form action="<?= base_url('PostController/postOptionsPost'); ?>" method="post">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu options-dropdown">
                                                            ...
                                                            <?php if (isAdmin()): ?>
                                                                <?php if ($item->petition_approve == 1): ?>
                                                                    <li>
                                                                        <button type="submit" name="option" class="btn-list-button" value="add-petition-approve">
                                                                            <i class="fa fa-times option-icon"></i><?= trans('reject'); ?>
                                                                        </button>
                                                                    </li>
                                                                <?php else: ?>
                                                                    <li>
                                                                        <button type="submit" name="option" class="btn-list-button" value="add-petition-approve">
                                                                            <i class="fa fa-plus option-icon"></i><?= trans('approve'); ?>
                                                                        </button>
                                                                    </li>
                                                                <?php endif;
                                                                if ($item->petition_activate == 1): ?>    
                                                                    <li>
                                                                        <button type="submit" name="option" class="btn-list-button" value="add-petition-activate">
                                                                            <i class="fa fa-times option-icon"></i><?= trans('deactivate'); ?>
                                                                        </button>
                                                                    </li>
                                                                <?php else: ?>
                                                                    <li>
                                                                        <button type="submit" name="option" class="btn-list-button" value="add-petition-activate">
                                                                            <i class="fa fa-plus option-icon"></i><?= trans('activate'); ?>
                                                                        </button>
                                                                    </li>
                                                                <?php endif;   
                                                                if ($item->is_slider == 1): ?>
