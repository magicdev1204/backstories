    ...
    <div class="col-sm-12">
        <div class="box">
            <div class="box-header with-border">
                    ...
                    <div class="right">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" style="left: -20px;">
                                ...
                                <li><a href="<?= adminUrl('add-petition'); ?>"><?= trans('add_petition'); ?></a></li>
				...
				?>
                <div class="right">
                    <a class="btn btn-info" href="<?php echo $twitter_auth_url;?>"><i class="fa fa-twitter"></i>
                    	LogIn with Twitter
                    </a>
                    &nbsp;
                </div>
				...
				?>
                <div class="right">
                    <a class="btn btn-info" href="<?php echo adminUrl('posts/tweet-logout');?>"><i class="fa fa-twitter"></i>
                                ...
                                <?php if (!empty($posts)):
                                    foreach ($posts as $item):
                                        ...
                                        <tr>
                                            ...
                                            <?php
											if($item->tweeted==2){
												$twts = $postAdminModel->getTweets($item->id);
												echo "<p><a href='https://twitter.com/".$twts[0]->tweet_by."/status/".$twts[0]->tweet_id."' target='_blank'>Tweeted</a></p><p>".date('d/m/Y h:i:s A', strtotime($twts[0]->tweet_date))."</p>";
												
											} else {
												if(isset($twitter_auth_url)){
												} else {
													//show tweet button
													if(isset($twitter_content->screen_name)){
														?>
                                                        <a class="btn btn-info" href="<?php echo adminUrl("posts/tweet/")."?id=".$item->id?>"><i class="fa fa-twitter"></i>
                                                            Tweet
                                                        </a>
                                                        <?php
													}
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu options-dropdown">
															...
															if(isset($twitter_auth_url)){
																...
																//show tweet button
																if(isset($twitter_content)){
																	?>
																	<li>
                                                                        <a href="<?php echo adminUrl("posts/tweetpreview/")."?id=".$item->id?>"><i class="fa fa-twitter"></i>
                                                                            Tweet Preview
                                                                        </a>
                                                                    </li>
																	<?php
