        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                	...
                	<li>
                    <?php 
					if(isset($twitter_auth_url) || !isset($_SESSION['twitter_content']->screen_name)){
						if(!isset($twitter_auth_url)){
							$twitter_auth_url = '';
						}
					?>
					
						<a class="btn btn-sm btn-info pull-left btn-site-prev" href="<?php echo $twitter_auth_url;?>" style="background-color: #3aadd7 !important;border-color: #3aadd7 !important;"><i class="fa fa-twitter"></i>
							LogIn with Twitter
						</a>
						&nbsp;
					
					<?php 
					} else if(isset($_SESSION['twitter_content']->screen_name)){
					?>
					
						<a class="btn btn-sm btn-info pull-left btn-site-prev" href="<?php echo adminUrl('posts/tweet-logout');?>" style="background-color: #3aadd7 !important;border-color: #3aadd7 !important;"><i class="fa fa-twitter"></i>
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                if (hasPermission('add_post')): ?>
                    <li class="treeview<?= isAdminNavActive(['add-post', 'add-petition', 'add-video']); ?>">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="nav-add-petition">
                                <a href="<?= adminUrl('add-petition'); ?>"><?= trans("add_petition"); ?></a>
                            </li>
                ...
                if (hasPermission('manage_all_posts') || hasPermission('add_post')): ?>
                    <li class="treeview<?= isAdminNavActive(['posts', 'petitions', 'slider-posts', 'our-picks', 'pending-posts', 'edit-post', 'edit-petition', 'auto-post-deletion']); ?>">
                        <a href="#">
                            <i class="fa fa-bars"></i> <span><?= trans("posts"); ?> / <?= trans("petitions"); ?></span><span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                        </a>
                        <ul class="treeview-menu">
                            <li class="nav-posts">
                                <?php
                                    $categoryModel = new \App\Models\CategoryModel();
                                    /*category='.$categoryModel->getCategoryBySlug('post')->id.'&*/
                                ?>
                                <a href="<?= adminUrl('posts?show=15&lang_id=&post_type=&author=&subcategory=&q='); ?>"><?= trans("posts"); ?></a>
                            </li>
                            <li class="nav-petitions">
                                <a href="<?= adminUrl('petitions??show=15&lang_id=&post_type=&author=&category='.$categoryModel->getCategoryBySlug('petition')->id.'&subcategory=&q='); ?>"><?= trans("petitions"); ?></a>
                            </li>
                    ...
                    <li class="treeview<?= isAdminNavActive(['import-feed', 'update-feed', 'feeds']); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li class="nav-articles">
                                <a href="<?= adminUrl('articles'); ?>"><?= trans("feed_articles"); ?></a>
                            </li>
                            <li class="nav-bundles">
                                <a href="<?= adminUrl('bundles'); ?>"><?= trans("bundles"); ?></a>
                            </li>
                            <li class="nav-collections">
                                <a href="<?= adminUrl('collections'); ?>"><?= trans("collections"); ?></a>
                            </li>
                        </ul>
                    </li>
                <?php endif;
