        ...
        <div class="box box-primary">
            ...
            <form action="<?= base_url('RssController/editFeedPost'); ?>" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">Filtering</label>
                        <select id="filtering" name="filtering" class="form-control max-500" required>
                            <option value="0" <?= ($feed->filtering == 0) ? 'selected' : '' ?> >Show All</option>
                            <option value="1" <?= ($feed->filtering == 1) ? 'selected' : '' ?> >Only this Category</option>
                        </select>
                    </div>
