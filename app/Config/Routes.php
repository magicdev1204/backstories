...
$routes->get('/att/(:any)', 'HomeController::attachment/$1');
$routes->get('/att-i/(:any)', 'HomeController::attachmentImage/$1');
...
$routes->get('add-sign', 'HomeController::addSign');
/*
 * --------------------------------------------------------------------
 * Auth Routes
 * --------------------------------------------------------------------
...
$routes->get($rAdmin . '/posts/tweet', 'PostController::tweet');
$routes->get($rAdmin . '/posts/tweetpreview', 'PostController::tweetPreview');
$routes->post($rAdmin . '/posts/post-tweet', 'PostController::postTweet');
$routes->get($rAdmin . '/posts/tweet-logout', 'PostController::twitterLogout');
...
$routes->get($rAdmin . '/add-petition', 'PostController::addPetition');
$routes->get($rAdmin . '/edit-petition/(:num)', 'PostController::editPetition/$1');
$routes->get($rAdmin . '/petitions', 'PostController::petitions');

//rss feeds
$routes->get($rAdmin . '/import-feed', 'RssController::importFeed');
$routes->get($rAdmin . '/feeds', 'RssController::rssFeeds');
$routes->get($rAdmin . '/articles', 'RssController::feedArticles');
$routes->get($rAdmin . '/bundles', 'RssController::bundles');
$routes->get($rAdmin . '/collections', 'RssController::collections');
