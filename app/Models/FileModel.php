    ...
    */
    ...
    public function UploadFile()
    {
        ...
        if (!empty($file)) {
            ...
            $data["shortened_url"] = $generateCode->generate_code();
            $db = \Config\Database::connect(null, false);
    ...
    public function getImageByShortUrl($shortened_url) {
        return $this->builderFiles->where('shortened_url', $shortened_url)->get()->getRow();
    }
}
