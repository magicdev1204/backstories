...
class RssModel extends BaseModel
{
    ...
    public function addFeedPosts($feedId)
    {
        ...
        if (!empty($feed)) {
            $feedurls = [
                'upwork.com' => "https://rss.app/feeds/oo5QaSFhn4euDRMy.xml",
                'freelancer.com' => "https://rss.app/feeds/nrL1pbmTnV7wFagQ.xml",
                'discord.com' => "https://rss.app/feeds/YY5WUUqHQYxcfJlX.xml",
                'paypal.com' => "https://rss.app/feeds/GsvmJj3EF8D0PkMR.xml",
                'https://upwork.com' => "https://rss.app/feeds/oo5QaSFhn4euDRMy.xml",
                'https://freelancer.com' => "https://rss.app/feeds/nrL1pbmTnV7wFagQ.xml",
                'https://discord.com' => "https://rss.app/feeds/YY5WUUqHQYxcfJlX.xml",
                'https://paypal.com' => "https://rss.app/feeds/GsvmJj3EF8D0PkMR.xml",
                'https://upwork.com/' => "https://rss.app/feeds/oo5QaSFhn4euDRMy.xml",
                'https://freelancer.com/' => "https://rss.app/feeds/nrL1pbmTnV7wFagQ.xml",
                'https://discord.com/' => "https://rss.app/feeds/YY5WUUqHQYxcfJlX.xml",
                'https://paypal.com/' => "https://rss.app/feeds/GsvmJj3EF8D0PkMR.xml",
            ];
            // $response = isset($feedurls[$feed->feed_url])  && $feedurls[$feed->feed_url] !=null ?  $feedurls[$feed->feed_url] : $feed->feed_url; 

            $response = isset($feedurls[$feed->feed_url]) && $feedurls[$feed->feed_url] != null ?  $parser->getFeeds($feedurls[$feed->feed_url]) : $parser->getFeeds($feed->feed_url); 
